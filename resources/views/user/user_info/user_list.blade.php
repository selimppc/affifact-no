                        ...
                        @if(isset($user_data))
                            @foreach($user_data as $values)
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        {{isset($values->relCountry->title)?$values->relCountry->title:''}}
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('user.show.data', $values->id) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#etsbModal" title="User List View"><i class="icon-eye-open"></i></a>
                                        <a href="{{ route('user.edit', $values->id) }}" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#etsbModal"><i class="icon-edit" title="User List Edit"></i></a>
                                        <a href="{{ route('user.destroy', $values->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to Delete?')" title="User List Delete"><i class="icon-trash"></i></a>
                                    </td>
                                    <td>
