                            ...
                            @foreach($message_data as $attachment)
                                <div class="" style="float:left;">
                                    @if($attachment->file_type == 'image')
                                        ...
                                        <div>
                                            <a href="{{ route('sub-message-followup.image.show', $attachment->id) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#imageView"><img src="{{ URL::to($attachment->file_name) }}" height="60px" width="60px" alt="{{$attachment->file_name}}" />
                                            </a>
                                        </div>
