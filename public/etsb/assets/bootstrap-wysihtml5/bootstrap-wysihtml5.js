    ...
    var tpl = {
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<form name='photo' id='imageUploadForm' enctype='multipart/form-data' action='" + location.protocol + "//" + location.hostname +"/etsb/assets/bootstrap-wysihtml5/upload/upload_image.php' method='post'>" +
            ...
            var insertImage = function() {
                if(insertImageModal.find("input[name=imageUploaded]").size() > 0) {
                    insertImageModal.find("input[name=imageUploaded]").each(function() {
                        var url = $(this).val();
                        // Http added because of image uploading
